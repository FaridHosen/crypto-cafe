...
const Coins = () => {
    ...
    return (
        <div className='px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2'>
            ...
            <div className='grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-item-center'>
                {
                    coins.map(coin => <CoinCard id={coin.id} coin={coin}></CoinCard>)
